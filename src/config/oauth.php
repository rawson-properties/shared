...
return [
    'providers' => [
        ...
        'rawsoncoza' => [
            ...
            'domain' => 'rawson.co.za',
            'redirectdomain' => env('OAUTH_REDIRECT_DOMAIN', 'rawson.co.za'),
            'client_id' => env('OAUTH_CLIENT_ID', '295637650675-efcjub1m8lspbu7n0j81dfq9t43h3it3.apps.googleusercontent.com'),
            'client_secret' => env('OAUTH_CLIENT_SECRET', 'yhjuSLsL4VYrPrARMsj3o03i'),
        ],
        'rawsonmu' => [
            'enabled' => env('OAUTH_MAURITIUS_ENABLED', false),
            'name' => 'Rawson Mauritius',
            'domain' => 'rawson.mu',
            'redirectdomain' => env('OAUTH_REDIRECT_DOMAIN', 'rawson.mu'),
